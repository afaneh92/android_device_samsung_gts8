...
Supported Models
-------------
Galaxy Tab S8 (Snapdragon): X706B, X706C, X706N and X700.

Download & Guide
-------------
                
1. Unlock your bootloader.
2. Downloads for Galaxy Tab S8 (Snapdragon): [gts8](https://www.androidfilehost.com/?w=files&flid=334656)
3. Reboot to download mode
4. Uncheck auto reboot in Odin and flash TWRP in AP slot and [vbmeta_disabled.tar](https://github.com/afaneh92/android_device_samsung_gts8/raw/github.io/docs/vbmeta_disabled.tar) in USERDATA slot.
...
[Device tree](https://github.com/afaneh92/android_device_samsung_gts8)

Changelog
-------------
[GitHub History](https://github.com/afaneh92/android_device_samsung_gts8/commits/android-12.1)
